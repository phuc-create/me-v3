    ...
    <div className="relative flex flex-wrap gap-6 p-4">
      ...
      {stackslist.map(tech => (
        <Badge
          key={tech.name}
          variant="secondary"
          className={`${tech.bgColor} flex cursor-pointer items-center gap-1.5 px-3 py-2 text-xs font-medium transition-colors`}
        >
          <Image
            ...
            width={16}
            height={16}
            className={cn('rounded-sm', tech.bgColor)}
          />
